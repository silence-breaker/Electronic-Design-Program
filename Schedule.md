...
| -------- | ------------------------------------------------- |
| LCJ      | PID 和显示模块的操控                              |
| WJ       | DCDC buck 电路 + 单片机供电+负载电路 |
| WYC      | 整流电路，调纹波 +保护电路+报销整理                       |
| 外形设计 | 待定                                              |
...
#### 单片机供电模块
- [ ] UA78M线性稳压器降压(缺点功耗大（10几W）但电路简单)
- [ ] 采用LDO降压25.5->3.3给单片机供电（LM1117 - 3.3 线性稳压器或 XL1509 - 3.3 开关稳压器）
- [ ] 直接内置锂电池供电


#### Buck 主电路
- [ ] 采用AOZ1284芯片成功搭建降压电路，且纹波小于或者接近15mV(采用数字电位器TPL0501调控电阻分压网络)
- [ ] 手搓
